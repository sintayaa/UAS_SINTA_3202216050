        ...
        <div class="row">
            <div class="col-lg-8 most-recent">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 item mb-4 pt-lg-3">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="detail.php?id=<?= $row['id'] ?>">
                                    <img class="card-img-bottom d-block radius-image" src="admin/uploads/<?= $row['foto'] ?>" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body p-0 blog-details">
                                <a href="detail.php?id=<?= $row['id'] ?>" class="blog-desc"><?= $row['judul'] ?></a>
